...
const NftCreate: NextPage = () => {
    ...
    const [nftMeta, setNftMeta] = useState<INFTMeta>({
        name: '',
        description: '',
        image: '',
        attributes: [
    ...
    const getSignedData = async () => {
        const msgToSign = await axios.get('/api/verify');
        ...
        const signedData = await ethereum?.request({
            ...
            params: [JSON.stringify(msgToSign.data), account, msgToSign.data.id]
        });
    ...
    const handleChangeImage = async (e: ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const fileres = await toast.promise(promise, {
            ...
            const data = fileres.data as PinataFileRes;
    ...
    const uploadMetadata = async () => {
        try {
            ...
            setLoadingBtn(false);
            const data = res.data as PinataFileRes;
            setNftURI(
